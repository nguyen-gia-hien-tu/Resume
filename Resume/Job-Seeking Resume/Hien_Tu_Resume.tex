...
\begin{small}
\begin{itemize}
    \item Obtained a \textbf{CGPA} of \textbf{3.97} on a 4.0 scale
    \item Recipient of McMaster Start Coding Honorarium for \textbf{more than 40 hours} of volunteer work
...
\begin{itemize}
    ...
    \item Applied and advanced in-class and self-educated knowledge on object-oriented programming to create the game
\end{itemize}
}
...
% Detailed achievements:%
\begin{itemize}
\item Visited schools to introduce children from grades 1 to 8 to Computer Science concepts
\item Taught children design thinking and programming knowledge to create pictures and games using the club's tool, written in \textbf{Elm} programming language
\end{itemize}}
% \vspace{1.0em}
