...
\item Advanced \textbf{communication}, \textbf{time management} and \textbf{collaboration} skills by replying to approximately \textbf{2000} emails from users, in a team of three support members and working with other developers in different time zones
\item Exhibited \textbf{documentation} skills by creating training guides for new users and developers, documenting new and existing features and updating work progress through Jira tickets
\end{itemize}
}
...
% Detailed achievements:%
\begin{itemize}
\item Visited schools and introduced children from grade 1 to 8 to Computer Science concepts
